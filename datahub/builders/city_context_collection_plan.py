    ...
    for city in cities:
        for metric_key, metric in domain_config.get("metrics", {}).items():
            ...
            rows.append({
                ...
                "evidence_quote": "",
                "metric_scope": "",
                "ranking_source_key": metric.get("ranking_source_key", ""),
                "ranking_name": metric.get("ranking_name", ""),
                "dimension_key": metric.get("dimension_key", metric_key),
                "dimension_name": metric.get("dimension_name", metric.get("label", "")),
                "rank_value": "",
                "score_value": "",
                "tier_label": "",
                "source_date": "",
